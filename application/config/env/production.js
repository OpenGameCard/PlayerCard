...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      url: 'postgresql://postgres:7s5IXnJLzY@postgresql.default.svc.cluster.local:5432/sails',
  ...
  session: {
    ...
    url: 'redis://:cMCkTTj2cv@redis-master.default.svc.cluster.local:6379',
    //--------------------------------------------------------------------------
  ...
  sockets: {
     ...
     *                                                                          *
     ***************************************************************************/
    onlyAllowOrigins: ["http://opengame.pl"]
